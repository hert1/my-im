       ...
       <#-- <#if !isLoggedIn>  是否登录
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <button id="submitCommentButton" onclick="submitComment('${article.cid}','${user.uid}');">提交</button>
            </td>
        </tr>
    </tbody>
</table>
...
<script type="text/javascript" src="/static/js/comment.js" charset="utf-8"></script>
<#--
